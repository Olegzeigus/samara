...
var style_KG_ADM_ISO_200_57 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_KG_ADM_ISO_200_57_eval_expression(context) !== null) {
        labelText = String(exp_label_KG_ADM_ISO_200_57_eval_expression(context));
    }
