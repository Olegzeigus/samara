...
var style_SCH_ADM_BUF_200_19 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_SCH_ADM_BUF_200_19_eval_expression(context) !== null) {
        labelText = String(exp_label_SCH_ADM_BUF_200_19_eval_expression(context));
    }
